 ...
 *
 */
public class SessionPersonFormBacker extends SessionPerson {
	...
	public SessionPersonFormBacker() {
...
//}
	...
	public SessionPersonFormBacker(String sessionGid, Role sessionRole, Person person) {
		setRole(sessionRole);
	...
	public SessionPersonFormBacker(SessionPerson sessionPerson, Person person) {
		super(sessionPerson);
