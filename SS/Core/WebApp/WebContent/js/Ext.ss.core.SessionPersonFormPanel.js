 ...
 *
 *  Description:
 *     SessionPersonFormPanel class.
 *     
 */
Ext.namespace('Ext.ss.core');

Ext.ss.core.SessionPersonFormPanel = function(config) {
	...
	var sessionPersonStore;
	if(formPanelConfig.sessionPersonStore) {
		sessionPersonStore  = formPanelConfig.sessionPersonStore;
		delete formPanelConfig.sessionPersonStore;
	} 
	else {
		sessionPersonStore = new Ext.data.JsonStore({
			autoDestroy:true,
			fields: [{
				name:'gid'
			},{
	...
	Ext.ss.core.SessionPersonFormPanel.superclass.constructor.call(this, formPanelConfig);
};

Ext.extend(Ext.ss.core.SessionPersonFormPanel, Ext.form.FormPanel, {
