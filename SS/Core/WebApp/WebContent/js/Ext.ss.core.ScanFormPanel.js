...
Ext.ss.core.ScanFormPanel = function(config) {
	...
	Ext.ss.core.ScanFormPanel.superclass.constructor.call(this, formPanelConfig);
};

Ext.extend(Ext.ss.core.ScanFormPanel, Ext.form.FormPanel, {
