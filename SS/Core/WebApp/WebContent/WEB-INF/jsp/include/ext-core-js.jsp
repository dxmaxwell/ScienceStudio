<%-- 
	...
	Description:
		Include Ext JS classes from Core.
--%>
<%@ page trimDirectiveWhitespaces="true" %>
<script type="text/javascript" src="/ss/js/Ext.ss.core.ProjectsGridPanel.js"></script>
<script type="text/javascript" src="/ss/js/Ext.ss.core.ExperimentFormPanel.js"></script>
<script type="text/javascript" src="/ss/js/Ext.ss.core.ProjectFormPanel.js"></script>
