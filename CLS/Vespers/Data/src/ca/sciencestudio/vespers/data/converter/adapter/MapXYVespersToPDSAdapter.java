 ...
 *
 */
public class MapXYVespersToPDSAdapter extends AbstractMapXYVespersConverter implements DataSource, StdConverter {

	private static final String DEFAULT_DATASET_NAME = "XRF_Data_Set";
	
	private static final String DEFAULT_CREATOR = MapXYVespersToPDSAdapter.class.getName();
	...
	public MapXYVespersToPDSAdapter(String fromFormat, String toFormat, boolean forceUpdate) {
